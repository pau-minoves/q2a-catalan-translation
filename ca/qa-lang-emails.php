...
*/
	...
	return array(
		...
		'confirm_body' => "Por favor, Si us plau, fes clic a l'enllaç següent per confirmar la teva adreça d'email a ^site_title.\n\n^url\n\nGracies, \n^site_title",
		'confirm_subject' => '^site_title - Confirmació d'adreça d'email',
		'feedback_body' => "Comentaris:\n^message\n\nNom:\n^name\n\nAdreça d'email:\n^email\n\nPàgina anterior:\n^previous\n\nUsuari:\n^url\n\nDirección IP:\n^ip\n\nNavegador:\n^browser",
		'feedback_subject' => '^ feedback',
		'flagged_body' => "Una publicació de ^p_handle ha rebut ^flags:\n\n^open^p_context^close\n\nFes clic en el següent enllaç per veure la publicació:\n\n^url\n\n\nFes clic en el següent enllaç per revisar totes les publicacions marcades:\n\n^a_url\n\n\nGracies,\n\n^site_title",
